...
CREATE TABLE HOADONBANHANG (
	...
	FOREIGN KEY (MAGIAM) REFERENCES MAGIAMGIA(MAGIAM)
);
...
BEGIN
    ...
    DECLARE @MANV VARCHAR(50), @MAKH VARCHAR(50), @NGAYHDBH DATE,
            @TONGTIEN DECIMAL(18,2), @DIEMTL INT, @MAGIAM VARCHAR(50), @GIAMGIA INT, @HINHTHUCTHANHTOAN BIT;
    ...
    INSERT INTO HOADONBANHANG (MAHDBH, MANV, MAKH, NGAYHDBH, TONGTIEN, DIEMTL, MAGIAM, GIAMGIA, HINHTHUCTHANHTOAN)
    VALUES (@NEW_MA, @MANV, @MAKH, @NGAYHDBH, @TONGTIEN, @DIEMTL, @MAGIAM, @GIAMGIA, @HINHTHUCTHANHTOAN);
END;
GO
